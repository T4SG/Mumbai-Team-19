			...
			<div class="container">
				<div class="row">
					...
					<div class="title text-center wow fadeIn" data-wow-duration="500ms">
						<h2>Set a<span class="color"> Personal Goal</span></h2>
					...
					<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" >
						<div class="wrap-about">							
							<form action="" method="POST">
					            ...
					            <label>Target Amount:  $</label><br><input type="number" name="amt" style="color:black" min="100" value="100" required> <br><br>	            
					            <label>Target Duration (in weeks) :</label><br><input type="number" name="duration" min="1" value="1" style="color:black" required>
						</div>
					</div> 
					<!-- End About item -->
