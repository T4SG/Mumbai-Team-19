			...
			<div class="container">
				<div class="row">
					...
					<div class="title text-center wow fadeIn" data-wow-duration="500ms">
						<h2>Donation<span class="color">S</span></h2>
					...
					<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms">
						<div class="service-block text-center">
							...
							<a href="donatetohhf.php"> <h3>Donate to Happy Hearts Fund</h3> </a>
							<p>Donate money, leave the rest to us. Happy Hearts incorporates methodical technologies to optimize the outcome. </p>
						</div>
					</article>
					...
					<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="200ms">
						<div class="service-block text-center">
							...
							<a href="personalgoal.php"> <h3>Set a Personal Goal</h3> </a>
							<p>Set a target. Network. Make allies! Chase a bigger donation amount by inviting your friends and family.</p>
						</div>
					</article>
                    <!-- End Single Service Item -->
					...
					<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
						<div class="service-block text-center">
							...
							<a href="donatetoschool.php"> <h3>Donate to a School</h3> </a>
							<p>Browse through our schools. Note our progress and monetary requirements. Handpick a school to donate to.</p>
						</div>
					</article>
					<!-- End Single Service Item -->
