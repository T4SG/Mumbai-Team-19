...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<!--	<div id="loading-mask">
            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="Navigation">
                    <ul id="nav" class="nav navbar-nav">
                        ...
                        <li><a href="#main-features">Cardio Rush Challenge</a></li>
		...
		==================================== -->
		<?php $connect=mysqli_connect('localhost', 'root', '','hhf') or trigger_error("Unable to connect to the database: " . mysqli_error()); ?>
		<section id="services" class="bg-one">
			<div class="container">
					
					<!-- section title -->
					<div class="title text-center wow fadeIn" data-wow-duration="500ms">
						<h2>Our <span class="color">Schools</span></h2>
    ...
    height: 150px; "> 
                    ...
                    <tr align="center" style="border: 1px solid; color: #8AC007;" border: 1px solid #8AC007;><td>School Name</td>
                    	<td>Location</td>
                    	<td>Calamity</td>
                    	<td>Year</td>
                    	<td>Total Cost for Rebuild</td>
                    	<td>Money Needed</td>
                    	<td>Progress</td>
                    	<td></td>
                    </tr>
                    <?php
                    $result=mysqli_query($connect,"SELECT * FROM school s,school_stage ss where s.ss_id=ss.ss_id");
                    $i=1;
