...
if(isset($_POST['donate'])) {
	...
	$q1=mysqli_query("insert into donation(d_id,u_id,amt,cause,s_id) values('','".$u_id."','".$amt."','".$cause."','".$s_id."');");
	echo '<script> alert("Thank you! Your donation has been received!"); </script>';
}  
			...
			<div class="container">
				<div class="row">
					...
					<div class="title text-center wow fadeIn" data-wow-duration="500ms">
						<h2>Donate to<span class="color"> Happy Hearts Fund</span></h2>
					...
					<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="250ms">
						...
						<center>
							<form action="login.php" method="POST">
					            ...
					            <label>Amount:  $</label><input type="number" name="amt" style="color:black" required> <br><br>	            
					            <label>Mode of Donation:</label>
					            <select name="mode" style="color:black">
									<option value="credit" style="color:black">Credit Card</option>
									<option value="debit" style="color:black">Debit Card</option>
									<option value="dd" style="color:black">Demand Draft</option>
								</select>	            
					            <br><br><input type="submit" name="donate" value="Donate" style="color:black"> <br><br>
