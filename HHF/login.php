...
if(isset($_POST['submit'])) {
	if((strlen($_POST['email'])!=0) && (strlen($_POST['password'])!=0)) {
		...
		$q1=mysqli_query("select * from users where email='".$email."' AND password='".$password."'");
		if(mysqli_num_rows($q1)==1) {
			$r1 = mysqli_fetch_assoc($q1);        
			session_start();
			$_SESSION['type'] = $r1['type'];
            $_SESSION['u_id'] = $r1['u_id'];
            if($_SESSION['type']=="donor")
            	header("location:donation.php");
            else if($_SESSION['type']=="admin")
			  header("location:admin.php");
			 else
			  header("location:school_cart.php");
		}
		else
			...
			<div class="container">
				<div class="row">
					...
					<div class="title text-center wow fadeIn" data-wow-duration="1500ms" >
						<h2>Login <span class="color"></span></h2>
					...
					<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="250ms">
						<div class="wrap-about">
							<form action="login.php" method="POST">
					            ...
					            <label>Password:   </label><input type="password" name="password" required> <br><br><br>	            
					            <input type="submit" name="submit" value="Login" style="color:black"> <br><br>
