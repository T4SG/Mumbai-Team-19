				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 text-center wow fadeInDown" data-wow-duration="500ms">
						<div class="counters-item">
							<div>
							    <span data-speed="3000" data-to="50000">50000</span>
							</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 text-center wow fadeInDown" data-wow-duration="500ms" data-wow-delay="200ms">
						<div class="counters-item">
							<div>
							    <span data-speed="3000" data-to="116">116</span>
							</div>
					...
					<!-- fourth count item -->
					<div class="col-md-3 col-sm-6 col-xs-12 text-center wow fadeInDown" data-wow-duration="900ms" data-wow-delay="1000ms">
						<div class="counters-item kill-margin-bottom">
							<div>
							    <span data-speed="3000" data-to="1430000">1430000</span>
							</div>
                            <img src="img/dollar.png" alt="Dollar" style="width:50px;height:50px;">
			...
			<div class="container">
				<div class="row">
					...
					<div class="title text-center wow fadeInUp" data-wow-duration="500ms">
						<h2>Our <span class="color">Collaboraters</span></h2>
						<div class="border"></div>
					</div>
					<!-- /section title -->
					...
					<div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms">
                       <article class="team-mate">
							<div class="member-photo">
								<!-- member photo -->
								<img class="img-responsive" src="img/jpfinal.jpg" alt="JPMorgan">
								<!-- /member photo -->
								
								<!-- member social profile -->
								<div class="mask">
									<ul class="clearfix">
										<li><a href="http://www.facebook.com/jpmorgancommunity"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://twitter.com/jpmorgan"><i class="fa fa-twitter"></i></a></li>
										<li><a href="http://www.linkedin.com/company/j-p-morgan"><i class="fa fa-linkedin"></i></a></li>
                           ...
                           <div class="member-info">
                               <p>An innovative band which measures your footsteps for which JPMorgan donates $1 for every 1000 footsteps...</p>
                           </div>
						   <!-- /about member -->
					...
					<div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="200ms">
                       <article class="team-mate">
							<div class="member-photo">
								...
								<div class="mask">
									<ul class="clearfix">
										<li><a href="http://www.facebook.com/Amazon"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://twitter.com/amazon"><i class="fa fa-twitter"></i></a></li>
										<li><a href="http://www.linkedin.com/company/amazon"><i class="fa fa-linkedin"></i></a></li>
							...
							<!-- about member -->
                           <div class="member-info">
                               <p>Amazon provides certain part of their earning to happy hearts fund aon early basis..which have helped HHF alot</p>
                           </div>
						   <!-- /about member -->
						</article>
                    </div>
					...
					<div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="400ms">
                       <article class="team-mate">
							<div class="member-photo">
								<!-- member photo -->
								<img class="img-responsive" src="img/youfinal.jpg" alt="Youtube">
								<!-- /member photo -->
								
								<!-- member social profile -->
								<div class="mask">
									<ul class="clearfix">
										<li><a href="http://www.facebook.com/youtube"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://twitter.com/YouTube"><i class="fa fa-twitter"></i></a></li>
										<li><a href="http://www.youtube.com/user/LinkedIn"><i class="fa fa-linkedin"></i></a></li>
							...
							<!-- about member -->
                           <div class="member-info">
                               <p>Youtube too helps Happy Hearts Fund to a great extent by supporting to rebuild schools and the children in their need.. </p>
                           </div>
						   <!-- /about member -->
                       </article>
                    </div>
					...
					<div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="600ms">
                       <article class="team-mate kill-margin-bottom">
							<div class="member-photo">
								<!-- member photo -->
								<img class="img-responsive" src="img/google.jpg" alt="Meghna" style:"height=500px;" >
								<!-- /member photo -->
								
								<!-- member social profile -->
								<div class="mask">
									<ul class="clearfix">
										<li><a href="http://www.facebook.com/Google"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://twitter.com/google?lang=en"><i class="fa fa-twitter"></i></a></li>
										<li><a href="http://www.linkedin.com/company/google"><i class="fa fa-linkedin"></i></a></li>
							...
							<!-- about member -->
                           <div class="member-info">
                               <p>Google have always been a great support to Happy Hearts Fund..You can also be a part of Collaboration with HHF..</p>
                           </div>
						   <!-- /about member -->
                       </article>
                    </div>
		...
		<section id="contact-us">
			<div class="container">
				<div class="row">
					...
					<!-- section title -->
					<div class="title text-center wow fadeIn" data-wow-duration="500ms">
						<h2>Donate and <span class="color">Make an Impact</span></h2>
						<div class="border"></div>
					</div>
					<!-- /section title -->
                    <?php
if(isset($_POST['submit']))
{
  ...
  echo "1";
  $query = "
  INSERT INTO `hhf`.`users` (`type`,`name`, `email`,`password`) VALUES ('donor', '$users_name',
...
?>
    ...
    <?php
/*            $con = mysqli_connect('localhost','root','','hhf') or die("error");
...
?>
				...
				<!--		<form id="contact-form1" method="get" name="register1" action="d1.php">
							...
							<div>
								<input type="submit" id="contact-submit" class="btn btn-transparent" name="submit" value="Submit" onclick="javascript:document.getElementById('contact-form1').submit()">
